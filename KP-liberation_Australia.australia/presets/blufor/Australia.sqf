...
FOB_truck_typename = "ADF_Truck_01_Repair_F";							// This is the FOB as a vehicle.																										Default is "B_Truck_01_box_F".
...
huron_typename = "ADF_Heli_Transport_01c_F";							// This is Spartan 01, a multipurpose mobile respawn as a helicopter. 																	Default is "B_Heli_Transport_03_unarmed_F".
crewman_classname = "ADFU_AMC_Cav_Crew";								// This defines the crew for vehicles. 																									Default is "B_crew_F".
pilot_classname = "ADF_SP_Helipilot";									// This defines the pilot for helicopters. 																								Default is "B_Helipilot_F".
KP_liberation_little_bird_classname = "ADF_Heli_Light_01_F";			// These are the little birds which spawn on the Freedom or at Chimera base.															Default is "B_Heli_Light_01_F".
KP_liberation_boat_classname = "B_T_Boat_Armed_01_minigun_F"; 			// These are the boats which spawn at the stern of the Freedom.																			Default is "B_Boat_Transport_01_F".
...
infantry_units = [
	["ADFU_AMC_Rifleman",15,0,0],										//Rifleman (Light)
	["ADFU_AMC_FTL",20,0,0],											//Rifleman
	["ADFU_AMC_Rifleman_LAT",30,0,0],									//Rifleman (AT)
	["ADFU_AMC_GL",25,0,0],												//Grenadier
	["ADFU_AMC_LMG",25,0,0],											//Autorifleman
	["ADFU_AMC_HMG",35,0,0],											//Heavygunner
	["ADFU_AMC_Marksman",30,0,0],										//Marksman
	["ADFU_AMC_Gustav_Gunner",50,10,0],									//AT Specialist
	["rhsusf_army_ocp_aa",50,10,0],										//AA Specialist
	["ADFU_AMC_CLS",30,0,0],											//Combat Life Saver
	["ADFU_AMC_Combat_Engineer",30,0,0],								//Engineer
	["ADFU_AMC_Combat_Engineer",30,0,0],								//Explosives Specialist
...
light_vehicles = [
	...
	["rhsusf_M1083A1P2_B_M2_WD_fmtv_usarmy",150,0,50],					//USTruckM2
	["rhsusf_rg33_m2_usmc_d",120,0,50],									//RG33
	["rhsusf_M1230_M2_usarmy_d",120,0,50],								//M1230 M2
	["rhsusf_mkvsoc",200,0,50]											//MK.V SOC
];
...
buildings = [
	...
	["Flag_US_F",0,0,0],
	["FLAG_AUS_F",0,0,0],
	["FLAG_ADFOPFOR_F",0,0,0],
	["Land_PierWooden_02_16m_F",0,0,0],
	["Land_ConcreteWall_01_m_8m_F",0,0,0],
	["Land_ConcreteWall_01_m_4m_F",0,0,0],
	["Land_MedicalTent_MTP_closed_F",0,0,0],
