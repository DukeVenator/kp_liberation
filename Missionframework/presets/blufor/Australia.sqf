...
FOB_truck_typename = "B_Truck _01_box_F";								// This is the FOB as a vehicle.																										Default is "B_Truck_01_box_F".
...
air_vehicles = [
	["B_UAV_01_F",15,0,10],												//AR-2 Darter
	["B_UAV_06_F",20,0,10],												//AL-6 Pelican (Cargo)
	...
	["B_Heli_Attack_01_dynamicLoadout_F",400,300,200],					//AH-99 Blackfoot
...
support_vehicles = [
	...
	["ACE_Wheel",10,0,0],
	["ACE_Track",10,0,0],
	["Land_Boxloader_Crate_Roofrack",0,0,0],							//Boxloader RoofRacks
	["Land_Boxloader_iso_20ft_black",0,0,0],
	["Land_Boxloader_iso_20ft_aid",0,0,0],
	["Land_Boxloader_Pallet_1",0,0,0],
	["Land_Boxloader_Pallet_2",0,0,0],
	["Land_Boxloader_Pallet_3",0,0,0],
...
elite_vehicles = [
	...
	"FIR_A10C_FT",														//A-10C (CAS)
	"FIR_F15K",															//F-15K Slamming Eagle
	"FIR_F15D",															//F-15D DEagle
	"FIR_F15E",															//F-15E Strike Eagle
	"FIR_F16D",															//F-16D (EXCEL)
	"FIR_F22",															//F-22 (2FU4)
